    ...
    public function block_sql_manager_list_panel($context, array $blocks = [])
    {
        ...
        echo "        <div class=\"row\">
            <div class=\"col\">
                ";
        // line 59
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "PrestaShopBundle:Admin/Configure/AdvancedParameters/RequestSql:index.html.twig", 59)->display(twig_array_merge($context, ["grid" => ($context["requestSqlGrid"] ?? null)]));
        // line 60
        echo "            </div>
        </div>
    ";
...
";
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Configure/AdvancedParameters/RequestSql:index.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters/RequestSql/index.html.twig");
    }
}
