  ...
  ";
    ...
    public function block_addresses_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 32
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "PrestaShopBundle:Admin/Sell/Address:index.html.twig", 32)->display(twig_array_merge($context, ["grid" => ($context["addressGrid"] ?? null)]));
        // line 33
        echo "      </div>
    </div>
  ";
...
";
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Sell/Address:index.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Sell/Address/index.html.twig");
    }
}
