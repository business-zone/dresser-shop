...
class __TwigTemplate_bcb7711c711b3d6f1dbfad0bcbdfe67e359eaae6776dd2855f616ed29db4dc00 extends \Twig\Template
{
      ...
      <tr>
        ...
        echo "Open-sans, sans-serif\" color=\"#555454\">
            <span>
              ";
        // line 22
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Your referred friend [1]{sponsored_firstname} {sponsored_lastname}[/1] has placed his or her first order on <a href=\"{shop_url}\">{shop_name}</a>!", ["[1]" => "<span><strong>", "[/1]" => "</strong></span>"], "Emails.Body", ($context["locale"] ?? $this->getContext($context, "locale")));
        echo "<br/><br/>
              ";
        // line 23
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("We are pleased to offer you a voucher worth [1]{discount_display} (voucher # {discount_name})[/1] that you can use on your next order.", ["[1]" => "<span><strong>", "[/1]" => "</strong></span>"], "Emails.Body", ($context["locale"] ?? $this->getContext($context, "locale")));
        echo "
            </span>
          </font>
        </td>
...
";
    ...
    {
        return array (  114 => 38,  110 => 37,  93 => 23,  89 => 22,  84 => 20,  68 => 7,  64 => 6,  60 => 4,  51 => 3,  29 => 1,);
    }
...
{% endblock %}
", "@MailThemes/classic/modules/referralprogram/referralprogram-congratulations.html.twig", "/var/www/html/mails/themes/classic/modules/referralprogram/referralprogram-congratulations.html.twig");
    }
}
