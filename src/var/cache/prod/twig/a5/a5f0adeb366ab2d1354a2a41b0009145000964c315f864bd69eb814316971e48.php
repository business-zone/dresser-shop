...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "WebProfilerBundle:Collector:validator.html.twig", "/var/www/html/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/validator.html.twig");
    }
}
