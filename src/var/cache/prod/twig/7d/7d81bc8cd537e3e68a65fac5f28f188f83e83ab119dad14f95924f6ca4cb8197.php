...
($context["module"] ?? null), "attributes", []), "url_active", []) != "buy")) {
      ...
      <div class=\"module-badges-action\">
        ...
        <div class=\"float-right module-action\">
          ";
        // line 221
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/action_menu.html.twig", "PrestaShopBundle:Admin/Module/Includes:modal_read_more_content.html.twig", 221)->display(twig_array_merge($context, ["module" => ($context["module"] ?? null), "level" => ($context["level"] ?? null)]));
        // line 222
        echo "        </div>
      </div>
    </div>
...
";
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Module/Includes:modal_read_more_content.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/modal_read_more_content.html.twig");
    }
}
