  ...
  ";
    ...
    <div class=\"row\">
      <div class=\"col\">
        ";
        // line 47
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "PrestaShopBundle:Admin/Sell/Catalog/Manufacturer:index.html.twig", 47)->display(twig_array_merge($context, ["grid" => ($context["manufacturerGrid"] ?? null)]));
        // line 48
        echo "      </div>
    </div>
  ";
    ...
    public function block_manufacturers_address_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 55
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "PrestaShopBundle:Admin/Sell/Catalog/Manufacturer:index.html.twig", 55)->display(twig_array_merge($context, ["grid" => ($context["manufacturerAddressGrid"] ?? null)]));
        // line 56
        echo "      </div>
    </div>
  ";
...
";
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Sell/Catalog/Manufacturer:index.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Sell/Catalog/Manufacturer/index.html.twig");
    }
}
