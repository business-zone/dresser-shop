  ...
  ";
    ...
    public function block_employee_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 49
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "PrestaShopBundle:Admin/Configure/AdvancedParameters/Employee:index.html.twig", 49)->display(twig_array_merge($context, ["grid" => ($context["employeeGrid"] ?? null)]));
        // line 50
        echo "      </div>
    </div>
  ";
...
";
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Configure/AdvancedParameters/Employee:index.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters/Employee/index.html.twig");
    }
}
