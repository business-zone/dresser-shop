  ...
  ";
    ...
    public function block_empty_categories_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 40
        $this->loadTemplate("PrestaShopBundle:Admin/Sell/Catalog/Monitoring:index.html.twig", "PrestaShopBundle:Admin/Sell/Catalog/Monitoring:index.html.twig", 40, "1170247017")->display(twig_array_merge($context, ["grid" => ($context["emptyCategoryGrid"] ?? null)]));
        // line 61
        echo "      </div>
    </div>
  ";
    ...
    public function block_no_qty_product_with_combinations_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 68
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "PrestaShopBundle:Admin/Sell/Catalog/Monitoring:index.html.twig", 68)->display(twig_array_merge($context, ["grid" => ($context["noQtyProductWithCombinationGrid"] ?? null)]));
        // line 69
        echo "      </div>
    </div>
  ";
    ...
    public function block_no_qty_product_without_combinations_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 76
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "PrestaShopBundle:Admin/Sell/Catalog/Monitoring:index.html.twig", 76)->display(twig_array_merge($context, ["grid" => ($context["noQtyProductWithoutCombinationGrid"] ?? null)]));
        // line 77
        echo "      </div>
    </div>
  ";
    ...
    public function block_disabled_product_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 84
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "PrestaShopBundle:Admin/Sell/Catalog/Monitoring:index.html.twig", 84)->display(twig_array_merge($context, ["grid" => ($context["disabledProductGrid"] ?? null)]));
        // line 85
        echo "      </div>
    </div>
  ";
    ...
    public function block_product_without_image_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 92
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "PrestaShopBundle:Admin/Sell/Catalog/Monitoring:index.html.twig", 92)->display(twig_array_merge($context, ["grid" => ($context["productWithoutImageGrid"] ?? null)]));
        // line 93
        echo "      </div>
    </div>
  ";
    ...
    public function block_product_without_description_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 100
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "PrestaShopBundle:Admin/Sell/Catalog/Monitoring:index.html.twig", 100)->display(twig_array_merge($context, ["grid" => ($context["productWithoutDescriptionGrid"] ?? null)]));
        // line 101
        echo "      </div>
    </div>
  ";
    ...
    public function block_product_without_price_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 108
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "PrestaShopBundle:Admin/Sell/Catalog/Monitoring:index.html.twig", 108)->display(twig_array_merge($context, ["grid" => ($context["productWithoutPriceGrid"] ?? null)]));
        // line 109
        echo "      </div>
    </div>
  ";
...
";
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Sell/Catalog/Monitoring:index.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Sell/Catalog/Monitoring/index.html.twig");
    }
}


/* PrestaShopBundle:Admin/Sell/Catalog/Monitoring:index.html.twig */
class __TwigTemplate_63e103fb653709cd0edcc6aea55af4056e084c3559247ca84c7f4f2fe628f55f___1170247017 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        parent::__construct($env);
