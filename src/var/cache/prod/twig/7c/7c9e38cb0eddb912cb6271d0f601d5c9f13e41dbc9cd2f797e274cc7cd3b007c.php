...
";
    ...
    public function block_employee_addons_connect($context, array $blocks = [])
    {
        // line 30
        echo "  ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/modal_addons_connect.html.twig", "PrestaShopBundle:Admin/Configure/AdvancedParameters/Employee/Blocks:form.html.twig", 30)->display(twig_array_merge($context, ["level" => ($context["level"] ?? null), "errorMessage" => ($context["errorMessage"] ?? null)]));
    }
...
";
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Configure/AdvancedParameters/Employee/Blocks:form.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters/Employee/Blocks/form.html.twig");
    }
}
