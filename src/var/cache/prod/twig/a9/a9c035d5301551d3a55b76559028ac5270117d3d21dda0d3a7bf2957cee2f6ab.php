  ...
  <div class=\"card-body\">
    ";
        ...
        <div class=\"col\">
          ";
            // line 36
            $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid.html.twig", "PrestaShopBundle:Admin/Sell/Customer/Blocks/View:discounts.html.twig", 36)->display(twig_array_merge($context, ["grid" => ($context["customerDiscountGrid"] ?? null)]));
            // line 37
            echo "        </div>
      </div>
    ";
...
";
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Sell/Customer/Blocks/View:discounts.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Sell/Customer/Blocks/View/discounts.html.twig");
    }
}
