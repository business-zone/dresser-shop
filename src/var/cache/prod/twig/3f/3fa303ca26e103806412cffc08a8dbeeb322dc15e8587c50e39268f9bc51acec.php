  ...
  <div class=\"card-body\">
    ";
        ...
        <div class=\"col\">
          ";
            // line 47
            $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid.html.twig", "PrestaShopBundle:Admin/Sell/Customer/Blocks/View:addresses.html.twig", 47)->display(twig_array_merge($context, ["grid" => ($context["customerAddressGrid"] ?? null)]));
            // line 48
            echo "        </div>
      </div>
    ";
...
";
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Sell/Customer/Blocks/View:addresses.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Sell/Customer/Blocks/View/addresses.html.twig");
    }
}
