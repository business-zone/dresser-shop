...
";
        // line 26
        $this->loadTemplate("PrestaShopBundle:Admin/Sell/Customer/Blocks:delete_modal.html.twig", "PrestaShopBundle:Admin/Sell/Customer/Blocks:delete_modal.html.twig", 26, "577546448")->display(twig_array_merge($context, ["id" => ($this->getAttribute(        // line 27
($context["grid"] ?? null), "id", []) . "_grid_delete_customers_modal"), "title" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("How do you want to delete the selected customers?", [], "Admin.Orderscustomers.Notification"), "closable" => true, "actions" => [0 => ["type" => "button", "label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Delete", [], "Admin.Actions"), "class" => "btn btn-danger btn-lg js-submit-delete-customers"]]]));
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Sell/Customer/Blocks:delete_modal.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Sell/Customer/Blocks/delete_modal.html.twig");
    }
}


/* PrestaShopBundle:Admin/Sell/Customer/Blocks:delete_modal.html.twig */
class __TwigTemplate_11762e72178c0e658829c4ef4da3e2cf873debd019952098e2f1b80d5c2a6284___577546448 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        parent::__construct($env);
